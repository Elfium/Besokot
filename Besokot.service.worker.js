...
/** @type {string} */
const CACHE_VERSION = '1771654102|62615053';
/** @type {string} */
const CACHE_PREFIX = 'Besokot-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Besokot.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Besokot.html","Besokot.js","Besokot.offline.html","Besokot.icon.png","Besokot.apple-touch-icon.png","Besokot.audio.worklet.js","Besokot.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Besokot.wasm","Besokot.pck"];
